...
def bot(board, color):
    ...
    if color == "WHITE":
            ...
            future_board_1 = move(board, king_position, "LEFT")
            future_board_2 = move(board, king_position, "RIGHT")

            if "BKi" not in future_board_1 or "BKi" not in future_board_2:
                change_direction = True

            if king_position + 2 <= 8 and board[king_position + 2] == "BKn":
                change_direction = True

            if king_position - 2 >= 0 and board[king_position - 2] == "BKn":
                change_direction = True

            if int_board == board:
                change_direction = bool(1 - int(change_direction))
            ...
            if "WKi" not in future_board_1 or "WKi" not in future_board_2:
                change_direction = True

            if king_position + 2 <= 8 and board[king_position + 2] == "WKn":
                change_direction = True

            if king_position - 2 >= 0 and board[king_position - 2] == "WKn":
                change_direction = True
...
def game_mechanics_bot(board):
    ...
    if color == "WHITE":
            while is_game_over(board) == False:
                ...
                if is_game_over(board) == True and "WKi" in board:
                    print(printable_board(board))
                    print("You win!")
                    return None
                elif is_game_over(board) == True and "WKi" not in board:
                    print(printable_board(board))
                    print("The bot wins!")
                    return None
                else:
                ...
                if is_game_over(board) == True and "Wki" not in board:
                    print(printable_board(board))
                    print("The bot wins!")
                    return None
            ...
            while is_game_over(board) == False:
                ...
                if is_game_over(board) == True and "BKi" in board:
                    print(printable_board(board))
                    print("You win!")
                    return None
                elif is_game_over(board) == True and "BKi" not in board:
                    print(printable_board(board))
                    print("The bot wins!")
                    return None
                else:
